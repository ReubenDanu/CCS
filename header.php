	...
	<div class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
      ...
      <nav class="navbar navbar-inverse">
          <div class="navbar-header">
            ...
            <h1><a class="navbar-brand" href="index.html"><span class="fa fa-area-chart"></span> PENGADUAN<span class="dashboard_text">MASYARAKAT</span></a></h1>
          </div>
            ...
            <ul class="sidebar-menu">
             ...
             <li class="treeview">
			  ...
			  <a class="nav-link" href="index.php">
                    <div class="fa fa-laptop"><i class="fas fa-tachometer-alt"></i></div>
                         Masyarakat
                        </a>
				...
				<a class="nav-link" href="data_tanggapan.php">
                    <div class="fa fa-laptop"><i class="fas fa-tachometer-alt"></i></div>
                     Tanggapan
                     </a>
